...
namespace elasticsearch_crud
{
    public class Elasticsearch
    {
        ...
        public async Task CreateIndexIfNotExists(string indexName)
        {
            ...
            Index(indexName);
            /* The dynamic keyword in C# allows for dynamic typing, where the type of variables is resolved at runtime rather than compile time. 
            It provides flexibility in handling objects and invoking methods or accessing properties that are not known until runtime. */
        }
